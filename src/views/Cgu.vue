...
<template>
  <div class="pt-20 min-h-screen bg-primary-600">
    <div class="max-w-7xl mx-auto px-4 py-12">
      <h1 class="text-4xl font-bold text-primary-100 mb-8">Conditions Générales d'Utilisation</h1>
      <div class="bg-primary-500/50 rounded-lg p-8 text-primary-100 space-y-4">
        ...
        <section>
          ...
          <p>Nous nous efforçons de fournir des informations à jour, mais nous ne garantissons pas l'exactitude ou l'exhaustivité des contenus affichés sur ce site.</p>
        </section>
        <section>
          <h2 class="text-2xl font-semibold text-primary-200 mb-2">5. Liens externes</h2>
          <p>Notre site peut contenir des liens vers des sites tiers. Nous ne sommes pas responsables du contenu ou des pratiques de ces sites.</p>
        </section>
        <section>
          <h2 class="text-2xl font-semibold text-primary-200 mb-2">6. Modifications des CGU</h2>
          <p>Nous nous réservons le droit de modifier ces conditions à tout moment. La version mise à jour sera publiée sur cette page.</p>
        </section>
        <section>
